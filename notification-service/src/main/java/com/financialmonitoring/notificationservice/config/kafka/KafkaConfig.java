package com.financialmonitoring.notificationservice.config.kafka;
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.notification-success}")
    private String notificationSuccessTopic;

    @Value("${spring.kafka.topic.notification-fail}")
    private String notificationFailTopic;
    ...
    public Set<NewTopic> buildTopics() {
        ...
        List<String> topics = List.of(
                orchestratorTopic,
                notificationSuccessTopic,
                notificationFailTopic);
