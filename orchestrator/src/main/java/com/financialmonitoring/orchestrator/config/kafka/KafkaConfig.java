package com.financialmonitoring.orchestrator.config.kafka;
...
public class KafkaConfig {
    ...
    public List<NewTopic> buildTopics() {
        ...
        return Arrays.stream(TransactionSagaTopics.values())
    ...
    private NewTopic createAndRegisterTopic(TransactionSagaTopics topic, BeanDefinitionRegistry registry) {
        String topicName = topic.getTransactionTopic();
